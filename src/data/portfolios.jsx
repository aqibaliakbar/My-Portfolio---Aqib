...
const portfolios = [
...

  {
    ...
    image: ReactDataWebsite,
    git: "https://github.com/aqibaliakbar/React-Data-Website-Using-Tailwind-CSS",
    live: "https://react-data-website1.netlify.app/",
    title: "React Data Website Using Tailwind CSS",
    text: "Tech Stack: React, Tailwind CSS",
    language: [
      {
        JavaScript: "95.8%",
        HTML: "3%",
    ...
    description:
      "<p>A sleek and efficient data-driven website built with React.js and styled using the power of Tailwind CSS. This venture into the realm of web development showcases not only my proficiency in React.js but also the seamless integration of Tailwind CSS for a clean and responsive user interface.</p><h3>Key Features:</h3><br/> <ul><li><b>React.js Functionality:</b> Harnessing the power of React.js, the website offers a seamless and reactive user experience, ensuring data is presented in an intuitive and user-friendly manner.</li><li><b>Tailwind CSS Styling:</b> The website's aesthetic appeal is enhanced by the simplicity and flexibility of Tailwind CSS. The utility-first approach of Tailwind streamlines the styling process, resulting in a clean and modern design.</li><li><b>Responsive Design:</b> Tailored for a variety of devices, the website adapts effortlessly to different screen sizes, maintaining functionality and aesthetics across desktops, tablets, and mobile phones.</li></ul<h3>React.js and Tailwind CSS Integration:</h3><p>The synergy between React.js and Tailwind CSS empowers this project with a robust frontend. React.js components manage the dynamic rendering of data, while Tailwind CSS ensures a consistent and visually appealing layout through its utility classes.</p><h3>Technologies Used:</h3><p>This project showcases a blend of cutting-edge technologies:</p><ul><li><b>React.js:</b> Driving the frontend with component-based architecture, ensuring efficient state management and data handling.</li><li><b>Tailwind CSS:</b> Streamlining the styling process with utility classes, enhancing the visual aesthetics of the website.</li></ul><p>Dive into the world of data with this React.js and Tailwind CSS-powered website. The amalgamation of robust frontend functionality and elegant design exemplifies my commitment to creating efficient, user-centric web solutions. I am eager to explore new horizons and tackle exciting challenges in future projects.</p>",
  },
